...
const zh: Record<string, string> = {
  ...
  'My Pantry': '我的食材库',
  'Search your foods': '搜索你的食材',
  'Add food by label photo': '拍营养标签添加食材',
  'Reading label…': '正在识别标签…',
  'No saved foods yet — add one by photographing a label.': '还没有保存的食材 — 拍一张营养标签添加。',
  'Could not read the label. Please try again.': '无法识别标签,请重试。',
  'Could not save to your pantry. Please try again.': '无法保存到食材库,请重试。',
  'tap to log': '点一下直接添加',
  'Added': '已添加',
